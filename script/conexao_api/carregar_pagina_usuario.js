        ...
        if (userData.tipo === "padrao") {
          ...
          if (post) {
            ...
            mainImagensUser.innerHTML =
              '<div class="buttonUser"><a href="adicionarProjeto.html"><button><img src="img/lupa+.svg" alt=""><p>Adicionar Projeto</p></button></a></div>'; // Limpa o conteúdo anterior
            ...
            document.getElementById(
              "mainImagensUser"
            ).innerHTML = `<div class="buttonUser"><a href="adicionarProjeto.html"><button><img src="img/lupa+.svg" alt=""><p>Adicionar Projeto</p></button></a></div>`;
          }
