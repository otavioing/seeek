...
let atualano = dataAtual.getFullYear();
...
function aplicarIdioma() {
  var idioma = {
    eng: {
      ...
      AvisoFooter: "Alerts",
      DireitosFooter: `All rights reserved. ©Seek ${atualano}`,
      ...
      SobrePrincipaltexto:
        "Our intention with Seek is to give visibility and greater opportunities to visual artists, as well as to provide increased contact with companieslooking for professionals with their skills.",
      SobreSubPrincipalTexto:
        "We also offer access to an education platform, allowing artists and other professionals to improve and stand out in the job market.",
      EquipeSob: "Team",
      ContatoEquipe:
        "If you need any further information about us or the website, please contact us through our social media channels.",
      SobreAllan:
        "Hello! My name is Allan and I am 18 years old. I am one of the collaborators responsible for developing JavaScript functionalities on the Seek website. I am committed to constantly improving myself and contributing to the growth and success of Seek. I am always looking for innovative ways to improve user experience and accessibility.",
      SobreCaua:
        "Hello, nice to meet you! My name is Cauã Eduardo. I am the Scrum Master of the Seek project. Along with the other team members, I was assigned to lead and coordinate the project, ensuring that everything runs as smoothly as possible. My main responsibility is to ensure the smooth progress of the project, but I am also always willing to help in all areas as needed.",
      SobreMiguel:
      ...
      SobreBruno:
        "Nice to meet you, my name is Bruno. Among the collaborators for the creation of the Seek website, I am responsible for JavaScript programming. My goal is to maintain the site's functionalities and make it as dynamic as possible.",
      SobreOtavio:
        "I am one of the main creators of Seek. I was born in 2006, in a small town in the interior of São Paulo. As the front-end responsible, I actively participate in almost all areas of the site's creation. My main function is to ensure that the site is functional for users, using technologies such as HTML5 and CSS.",
      SobreJoao:
        "My name is João Felipe and I was born in 2006. I am one of the collaborators in the creation of the Seek website, with a main focus on CSS implementation. I ensure that our aesthetics are visually pleasing and accessible on various platforms.",

      OpçãoSim: "Yes",
      OpçãoNão: "No",
      Pergunta1: "Do you want everyone to see your profile in the search area?",
      Pergunta2:
        "Do you want everyone to see your projects in the search area?",
      Pergunta3: "Do you want everyone to see your courses in the search area?",
      Pergunta4: "Do you want everyone to see your email?",
      Pergunta5:
        "Do you want to receive a summary of your notifications by email?",
      Pergunta6:
        "Do you want to receive an immediate notification of contract requests?",
      Pergunta7:
        "Do you want to receive an immediate notification when someone requests to join a team?",
      Pergunta8:
        "Do you want to receive notification when there are offers/discounts?",
      Pergunta9:
        "Do you want to receive notification when there are offers/discounts?",
      Pergunta10: "Use accessibility bar?",
      Pergunta11:
        "Do not allow third parties to embed your content on other sites?",
      ...
      AjudaTextoUsuario:
        "Starting with the user part, you can configure your account as you like and even change its type, choosing an account type for teachers, or the default (artists), or company.",
      AjudaTextoPortifolio:
        "Starting with the user part, you can configure your account as you like and even change its type, choosing an account type for teachers, or the default (artists), or company.",
      AjudaCursoseVagasTexto:
        "Similar to the portfolio, you can access the course or job by clicking on its cover, and if you want more information, just click on 'more information' to see better the job or course specifications, as well as being able to access the courses you want via the search bar or menu by going to 'courses' or 'jobs'.",
      AjudaCadastroGeral:
        "On the login/registration page, use your main or preferred email to access the site if you want, otherwise just click on the arrow in the top right corner to access the site as anonymous.",
    ...
    es: {
      ...
      AvisoFooter: "Avisos",
      DireitosFooter: `Todos los derechos reservados. ©Seek ${atualano}`,
      ...
      SobrePrincipaltexto:
        "Nuestra intención con Seek es dar visibilidad y mayores oportunidades a los artistas visuales, además de proporcionar un mayor contacto con empresas que buscan profesionales con sus capacidades",
      SobreSubPrincipalTexto:
        "También ofrecemos acceso a una plataforma de educación, permitiendo que artistas y otros profesionales puedan mejorar y destacarse en el mercado laboral.",
      EquipeSob: "Equipo",
      ContatoEquipe:
        "Si necesita más información sobre nosotros o sobre el sitio, contáctenos a través de nuestras redes sociales.",
      SobreAllan:
        "¡Hola! Mi nombre es Allan y tengo 18 años. Soy uno de los colaboradores responsables del desarrollo de funcionalidades en JavaScript en el sitio Seek. Estoy comprometido a mejorar constantemente y contribuir al crecimiento y éxito de Seek. Siempre estoy buscando formas innovadoras de mejorar la experiencia del usuario y la accesibilidad.",
      SobreCaua:
        "¡Hola, mucho gusto! Mi nombre es Cauã Eduardo. Soy el Scrum Master del proyecto Seek. Junto con los otros miembros del equipo, fui asignado para liderar y coordinar el proyecto, asegurando que todo funcione de la mejor manera posible. Mi principal responsabilidad es asegurar el buen progreso del proyecto, pero también estoy siempre dispuesto a ayudar en todas las áreas según sea necesario.",
      SobreMiguel:
      ...
      SobreBruno:
        "Mucho gusto, mi nombre es Bruno. Entre los colaboradores para la creación del sitio Seek, soy el responsable de la programación en JavaScript. Mi objetivo es mantener las funcionalidades del sitio y hacerlo lo más dinámico posible.",
      SobreOtavio:
        "Soy uno de los principales creadores de Seek. Nací en 2006, en una pequeña ciudad del interior de São Paulo. Como responsable del front-end, participo activamente en casi todas las áreas de la creación del sitio. Mi función principal es asegurar que el sitio sea funcional para los usuarios, utilizando tecnologías como HTML5 y CSS.",
      SobreJoao:
        "Mi nombre es João Felipe y nací en 2006. Soy uno de los colaboradores en la creación del sitio Seek, con un enfoque principal en la implementación de CSS. Aseguro que nuestra estética sea visualmente agradable y accesible en diversas plataformas.",

      OpçãoSim: "Sí",
      OpçãoNão: "No",
      Pergunta1:
        "¿Desea que todos puedan ver su perfil en el área de búsqueda?",
      Pergunta2:
        "¿Desea que todos puedan ver sus proyectos en el área de búsqueda?",
      Pergunta3:
        "¿Desea que todos puedan ver sus cursos en el área de búsqueda?",
      Pergunta4: "¿Desea que todos puedan ver su correo electrónico?",
      Pergunta5:
        "¿Desea recibir un resumen de sus notificaciones por correo electrónico?",
      Pergunta6:
        "¿Desea recibir una notificación inmediata de solicitudes de contrato?",
      Pergunta7:
        "¿Desea recibir una notificación inmediata cuando alguien solicite unirse a un equipo?",
      ...
      Pergunta11:
        "¿No permitir que terceros incorporen su contenido en otros sitios?",
      ...
      AjudaTextoUsuario:
        "Comenzando por la parte del usuario, puedes configurar tu cuenta como desees e incluso cambiar su tipo, eligiendo un tipo de cuenta para profesores, o la predeterminada (artistas), o empresa.",
      AjudaTextoPortifolio:
        "Comenzando por la parte del usuario, puedes configurar tu cuenta como desees e incluso cambiar su tipo, eligiendo un tipo de cuenta para profesores, o la predeterminada (artistas), o empresa.",
      AjudaCursoseVagasTexto:
        "Similar al portafolio, puedes acceder al curso o vacante haciendo clic en su portada, y si quieres más información, simplemente haz clic en 'más información' para ver mejor las especificaciones de la vacante o del curso, además de poder acceder a los cursos que desees a través de la barra de búsqueda o del menú yendo a 'cursos' o 'vacantes'.",
      AjudaCadastroGeral:
        "En la página de inicio/sesión, usa tu correo principal o de preferencia para acceder al sitio si deseas, de lo contrario simplemente haz clic en la flecha en la esquina superior derecha para acceder al sitio como anónimo.",
    ...
    it: {
      ...
      AvisoFooter: "Avvisi",
      DireitosFooter: `Tutti i diritti riservati. ©Seek ${atualano}`,
      ...
      SobrePrincipaltexto:
        "La nostra intenzione con Seek è dare visibilità e maggiori opportunità agli artisti visivi, oltre a favorire un maggiore contatto con le aziende che cercano professionisti con le loro capacità",
      SobreSubPrincipalTexto:
        "Offriamo anche accesso a una piattaforma educativa, consentendo ad artisti e altri professionisti di migliorarsi e distinguersi nel mercato del lavoro.",
      EquipeSob: "Squadra",
      ContatoEquipe:
        "Se hai bisogno di ulteriori informazioni su di noi o sul sito, contattaci attraverso i nostri social media.",
      SobreAllan:
        "Ciao! Mi chiamo Allan e ho 18 anni. Sono uno dei collaboratori responsabili dello sviluppo delle funzionalità JavaScript sul sito Seek. Sono impegnato a migliorarmi costantemente e a contribuire alla crescita e al successo di Seek. Cerco sempre modi innovativi per migliorare l'esperienza utente e l'accessibilità.",
      SobreCaua:
        "Ciao, piacere! Mi chiamo Cauã Eduardo. Sono il Scrum Master del progetto Seek. Insieme agli altri membri del team, sono stato incaricato di guidare e coordinare il progetto, assicurando che tutto proceda nel miglior modo possibile. La mia principale responsabilità è garantire il buon andamento del progetto, ma sono anche sempre disposto ad aiutare in tutte le aree secondo necessità.",
      SobreMiguel:
      ...
      SobreBruno:
        "Piacere, mi chiamo Bruno. Tra i collaboratori per la creazione del sito Seek, sono responsabile della programmazione in JavaScript. Il mio obiettivo è mantenere le funzionalità del sito e renderlo il più dinamico possibile.",
      SobreOtavio:
        "Sono uno dei principali creatori di Seek. Sono nato nel 2006, in una piccola città dell'interno di São Paulo. Come responsabile del front-end, partecipo attivamente a quasi tutte le aree della creazione del sito. La mia funzione principale è garantire che il sito sia funzionale per gli utenti, utilizzando tecnologie come HTML5 e CSS.",
      SobreJoao:
        "Mi chiamo João Felipe e sono nato nel 2006. Sono uno dei collaboratori nella creazione del sito Seek, con un focus principale sull'implementazione del CSS. Garantisco che la nostra estetica sia visivamente piacevole e accessibile su varie piattaforme.",

      OpçãoSim: "Sì",
      OpçãoNão: "No",
      Pergunta1:
        "Vuoi che tutti possano vedere il tuo profilo nell'area di ricerca?",
      Pergunta2:
        "Vuoi che tutti possano vedere i tuoi progetti nell'area di ricerca?",
      Pergunta3:
        "Vuoi che tutti possano vedere i tuoi corsi nell'area di ricerca?",
      Pergunta4: "Vuoi che tutti possano vedere la tua email?",
      Pergunta5: "Vuoi ricevere un riepilogo delle tue notifiche via email?",
      Pergunta6:
        "Vuoi ricevere una notifica immediata per richieste di contratto?",
      Pergunta7:
        "Vuoi ricevere una notifica immediata quando qualcuno chiede di partecipare a un team?",
      ...
      Pergunta11:
        "Non consentire a terzi di incorporare il tuo contenuto in altri siti?",
      PrivacidadeConf: "Privacy",
      ...
      AjudaTextoUsuario:
        "A partire dalla parte utente, puoi configurare il tuo account come preferisci e anche modificare il tipo, scegliendo tra un account per insegnanti, l'account standard (artisti) o aziendale.",
      AjudaTextoPortifolio:
        "A partire dalla parte utente, puoi configurare il tuo account come preferisci e anche modificare il tipo, scegliendo tra un account per insegnanti, l'account standard (artisti) o aziendale.",
      AjudaCursoseVagasTexto:
        "Simile al portfolio, puoi accedere al corso o all'offerta di lavoro facendo clic sulla copertina, e se desideri ulteriori informazioni, basta fare clic su 'maggiori informazioni' per vedere meglio le specifiche dell'offerta o del corso. Inoltre, puoi anche accedere ai corsi che desideri attraverso la barra di ricerca o il menu andando su 'corsi' o 'offerte di lavoro'.",
      AjudaCadastroGeral:
        "Nella pagina di accesso/registrazione, utilizza la tua email principale o preferita per poter accedere al sito se lo desideri, altrimenti basta fare clic sulla freccia in alto a destra per accedere al sito come anonimo.",
    ...
    fr: {
      ...
      ContatoFooter: "Contacts",
      AvisoFooter: "Avis",
      DireitosFooter: `Tous droits réservés. ©Seek ${atualano}`,
      ...
      SobrePrincipaltexto:
        "Notre intention avec Seek est de donner visibilité et plus d'opportunités aux artistes visuels, tout en facilitant un plus grand contact avec les entreprises qui recherchent des professionnels avec leurs compétences",
      SobreSubPrincipalTexto:
        "Nous offrons également l'accès à une plateforme éducative, permettant aux artistes et autres professionnels de s'améliorer et de se démarquer sur le marché du travail.",
      EquipeSob: "Équipe",
      ContatoEquipe:
        "Si vous avez besoin de plus d'informations sur nous ou sur le site, contactez-nous via nos réseaux sociaux.",
      SobreAllan:
        "Bonjour! Je m'appelle Allan et j'ai 18 ans. Je suis l'un des collaborateurs responsables du développement des fonctionnalités JavaScript sur le site Seek. Je m'engage à m'améliorer constamment et à contribuer à la croissance et au succès de Seek. Je cherche toujours des moyens innovants d'améliorer l'expérience utilisateur et l'accessibilité.",
      SobreCaua:
        "Bonjour, enchanté! Je m'appelle Cauã Eduardo. Je suis le Scrum Master du projet Seek. Avec les autres membres de l'équipe, j'ai été chargé de diriger et de coordonner le projet, en veillant à ce que tout se passe le mieux possible. Ma principale responsabilité est d'assurer le bon déroulement du projet, mais je suis également toujours prêt à aider dans tous les domaines selon les besoins.",
      SobreMiguel:
      ...
      SobreBruno:
        "Enchanté, je m'appelle Bruno. Parmi les collaborateurs pour la création du site Seek, je suis responsable de la programmation en JavaScript. Mon objectif est de maintenir les fonctionnalités du site et de le rendre aussi dynamique que possible.",
      SobreJoao:
        "Je m'appelle João Felipe et je suis né en 2006. Je suis l'un des collaborateurs de la création du site Seek, avec un focus principal sur la mise en œuvre du CSS. Je veille à ce que notre esthétique soit visuellement agréable et accessible sur diverses plateformes.",
      SobreOtavio:
        "Je suis l'un des principaux créateurs de Seek. Je suis né en 2006, dans une petite ville de l'intérieur de São Paulo. En tant que responsable du front-end, je participe activement à presque tous les domaines de la création du site. Ma fonction principale est de garantir que le site soit fonctionnel pour les utilisateurs, en utilisant des technologies telles que HTML5 et CSS.",

      OpçãoSim: "Oui",
      OpçãoNão: "Non",
      Pergunta1:
        "Souhaitez-vous que tout le monde puisse voir votre profil dans la zone de recherche?",
      Pergunta2:
        "Souhaitez-vous que tout le monde puisse voir vos projets dans la zone de recherche?",
      Pergunta3:
        "Souhaitez-vous que tout le monde puisse voir vos cours dans la zone de recherche?",
      Pergunta4: "Souhaitez-vous que tout le monde puisse voir votre email?",
      Pergunta5:
        "Souhaitez-vous recevoir un résumé de vos notifications par email?",
      Pergunta6:
        "Souhaitez-vous recevoir une notification immédiate des demandes de contrat?",
      Pergunta7:
        "Souhaitez-vous recevoir une notification immédiate lorsque quelqu'un demande à rejoindre une équipe?",
      Pergunta8:
        "Souhaitez-vous recevoir des notifications lorsqu'il y a des offres/remises?",
      Pergunta9:
        "Souhaitez-vous recevoir des notifications lorsqu'il y a des offres/remises?",
      Pergunta10: "Utiliser la barre d'accessibilité ?",
      Pergunta11:
        "Ne pas permettre à des tiers d'incorporer votre contenu sur d'autres sites?",
      ...
      AjudaTextoUsuario:
        "En commençant par la partie utilisateur, vous pouvez configurer votre compte comme vous le souhaitez et même en modifier le type, en choisissant un type de compte pour enseignants, ou le type standard (artistes), ou entreprise.",
      AjudaTextoPortifolio:
        "En commençant par la partie utilisateur, vous pouvez configurer votre compte comme vous le souhaitez et même en modifier le type, en choisissant un type de compte pour enseignants, ou le type standard (artistes), ou entreprise.",
      AjudaCursoseVagasTexto:
      ...
      AjudaCadastroGeral:
        "Sur la page de connexion/inscription, utilisez votre email principal ou préféré pour pouvoir accéder au site si vous le souhaitez, sinon il suffit de cliquer sur la flèche en haut à droite pour accéder au site en tant qu'anonyme.",
    ...
    pt: {
      ...
      AvisoFooter: "Avisos",
      DireitosFooter: `Todos os direitos reservados. ©Seek ${atualano}`,
      ...
      SobrePrincipaltexto:
        "Nossa intenção com o Seek é dar visibilidade e maiores oportunidades aos artistas visuais, além de proporcionar um maior contato com empresas que buscam profissionais com suas capacidades",
      SobreSubPrincipalTexto:
        "Também oferecemos acesso a uma plataforma de educação, permitindo que artistas e outros profissionais possam se aprimorar e se destacar no mercado de trabalho.",
      EquipeSob: "Equipe",
      ContatoEquipe:
        "Caso precise de mais alguma informação sobre nós ou sobre o site, entre em contato conosco através das nossas redes sociais.",
      SobreAllan:
        "Olá! Meu nome é Allan e tenho 18 anos. Sou um dos colaboradores responsáveis pelo desenvolvimento das funcionalidades em JavaScript no site Seek, estou comprometido em me aprimorar constantemente e contribuir para o crescimento e sucesso da Seek. Estou sempre buscando maneiras inovadoras de melhorar a experiência dos usuários e a acessibilidade.",
      SobreCaua:
        " Olá, prazer! Meu nome é Cauã Eduardo. Sou o Scrum Master do projeto Seek. Junto aos outros membros da equipe, fui designado para liderar e coordenar o projeto, garantindo que tudo ocorra da melhor forma possível. Minha principal responsabilidade é assegurar o bom andamento do projeto, mas também estou sempre disposto a ajudar em todas as áreas, conforme necessário.",
      SobreMiguel:
      ...
      SobreBruno:
        "Prazer, meu nome é Bruno, dentre os colaboradores para criação do site Seek eu sou o responsavel pela programação em JavaScript, meu objetivo é manter as funcionalidades do Site e deixar o mais dinâmico possivel",
      SobreOtavio:
        "Eu sou um dos principais criadores do Seek. Nasci em 2006, em uma pequena cidade no interior de São Paulo. Como responsável pelo front-end, participo ativamente em quase todas as áreas da criação do site. Minha função principal é garantir que o site seja funcional para os usuários, utilizando tecnologias como HTML5 e CSS.",
      SobreJoao:
        "Meu nome é João Felipe e nasci em 2006. Sou um dos colaboradores da criação do site Seek, com foco principal na implementação de CSS. Eu garanto que nossa estética seja visualmente agradável e acessível em diversas plataformas.",
      ...
      Pergunta6:
        "Deseja receber uma notificação imediata de solicitação de contrato?",
      Pergunta7:
        "Deseja receber uma notificação imediata quando solicitarem para participar de uma equipe ?",
      ...
      Pergunta11:
        "Não permitir que terceiros incorporem seu conteúdo em outros sites?",
      ...
      AjudaTextoUsuario:
        "Começando pela parte do usuário, você pode configurar sua conta da forma como quiser e até podendo alterar o tipo dela, podendo selecionar um tipo de conta para professores,ou a padrão(artistas), ou empresa.",
      AjudaTextoPortifolio:
        "Começando pela parte do usuário, você pode configurar sua conta da forma como quiser e até podendo alterar o tipo dela, podendo selecionar um tipo de conta para professores,ou a padrão(artistas), ou empresa.",
      AjudaCursoseVagasTexto:
        "Semelhante ao portfólio, você pode acesar o curso ou vaga ao clicar na sua capa, e caso queira mais informações, é só clicar em “mais informações” para poder ver melhor as especificações da vaga, ou do curso, além também poder acesar os cursos que você queira pela barra de pesquisa ou pelo menu inddo em “cursos” ou “vagas”",
      AjudaCadastroGeral:
        "Na página de entra/cadastro, você utiliza seu e-mail principal ou de preferência para poder acesar o site caso queira, do contrário é só clicar na seta no canto superior direito para acessar o site como anônimo",
  ...
  for (var i = 0; i < TendenciasProjetos.length; i++) {
    TendenciasProjetos[i].innerHTML =
      idioma[selectedLanguage].ProjetosTendencias;
  }
  ...
  for (var i = 0; i < TrocarDeUsuarioPerfil.length; i++) {
    TrocarDeUsuarioPerfil[i].innerHTML =
      idioma[selectedLanguage].PerfilTrocarDeUsuario;
  }

  var CidadesPaisesPerfil = document.getElementsByClassName("UsoCP");
  for (var i = 0; i < CidadesPaisesPerfil.length; i++) {
    CidadesPaisesPerfil[i].innerHTML =
      idioma[selectedLanguage].PerfilCidadesPaises;
  }
  ...
  for (var i = 0; i < PesquisarPlaceholder.length; i++) {
    PesquisarPlaceholder[i].placeholder =
      idioma[selectedLanguage].PesquisarPlace;
  }
  ...
  for (var i = 0; i < menuConfiguracao.length; i++) {
    menuConfiguracao[i].innerHTML =
      idioma[selectedLanguage].PerfilConfiguracoes;
  }
  ...
  for (var i = 0; i < PersonalizarBotao.length; i++) {
    PersonalizarBotao[i].innerHTML =
      idioma[selectedLanguage].PersonalizarFiltro;
  }
  ...
  for (var i = 0; i < FerramentasCompartilhar.length; i++) {
    FerramentasCompartilhar[i].innerHTML =
      idioma[selectedLanguage].ModalCompartilhar;
  }
  ...
  for (var i = 0; i < TempoEmHorasDoCursos.length; i++) {
    TempoEmHorasDoCursos[i].innerHTML =
      idioma[selectedLanguage].TempoEmHorasCursos;
  }
  ...
  for (var i = 0; i < PrecodecadaCursoDoCurso.length; i++) {
    PrecodecadaCursoDoCurso[i].innerHTML =
      idioma[selectedLanguage].PrecodecadaCurso;
  }
  ...
  for (var i = 0; i < AjudaPortifolioAjuda.length; i++) {
    AjudaPortifolioAjuda[i].innerHTML =
      idioma[selectedLanguage].AjudaPortifolio;
  }

  var AjudaCursoseVagasAjuda = document.getElementsByClassName("CeVA");
  for (var i = 0; i < AjudaCursoseVagasAjuda.length; i++) {
    AjudaCursoseVagasAjuda[i].innerHTML =
      idioma[selectedLanguage].AjudaCursoseVagas;
  }
  ...
  for (var i = 0; i < AjudaTextoUsuarioAjuda.length; i++) {
    AjudaTextoUsuarioAjuda[i].innerHTML =
      idioma[selectedLanguage].AjudaTextoUsuario;
  }

  var AjudaTextoPortifolioAjuda = document.getElementsByClassName("TexPA");
  for (var i = 0; i < AjudaTextoPortifolioAjuda.length; i++) {
    AjudaTextoPortifolioAjuda[i].innerHTML =
      idioma[selectedLanguage].AjudaTextoPortifolio;
  }
  ...
  for (var i = 0; i < AjudaCursoseVagasTextoAjuda.length; i++) {
    AjudaCursoseVagasTextoAjuda[i].innerHTML =
      idioma[selectedLanguage].AjudaCursoseVagasTexto;
  }

  var AjudaCadastroGeralAjuda = document.getElementsByClassName("CadAT");
  for (var i = 0; i < AjudaCadastroGeralAjuda.length; i++) {
    AjudaCadastroGeralAjuda[i].innerHTML =
      idioma[selectedLanguage].AjudaCadastroGeral;
  }
